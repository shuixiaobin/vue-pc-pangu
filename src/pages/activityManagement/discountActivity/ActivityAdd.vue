...
import {
  postDiscountActivity,
  setDiscountActivityUpdate,
...
const XhrFunMap = {
  create: postDiscountActivity,
  update: setDiscountActivityUpdate,
  detail: getDiscountActivityDetail,
};
export default {
  components: {
    StepView,
  ...
  data() {
    return {
      loading: false,
      activityModule: 'discountActivity',
      ActivityClass: DiscountActivity,
      stepComponents: [
        {
          title: '基础信息',
