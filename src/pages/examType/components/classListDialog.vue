            ...
            isClassCheckAll(flag) {
                ...
                this.classList.data.map(item => {
                    ...
                    if (flag) {
                        item.checked = true
                        if (
                            !this.checkClassList.data.some(v => v.rid == item.rid)
                        ) {
                            this.checkClassList.data.push(item)
                        }
                    } else {
