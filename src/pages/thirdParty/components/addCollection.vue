...
<script>
  import { addCollectList, addPartnerClass } from '@/api/thirdParty'
  ...
  export default {
    ...
    methods: {
      ...
      offDialog() {
        this.page.class_page = 1
        this.$emit('update:collectionDialogVisible', false)
      }
    },
    watch: {
