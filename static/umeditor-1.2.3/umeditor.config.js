...
(function() {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        UMEDITOR_HOME_URL: URL
            ...
            //图片上传配置区
            ,
        imageUrl:  sessionStorage.getItem("WEBPACK_AJAX_BASE_URL")+"/pand/file/upload" //图片上传提交地址
            ,
        imagePath: sessionStorage.getItem("WEBPACK_AJAX_BASE_URL")+"/pand/file/upload" //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
            ,
